...
const ROLE_SYNONYMS: Record<string, Role> = {
  ...
  'culture secretary': 'culturalSecretary',
  'game secretary': 'gameSecretary',
  'games secretary': 'gameSecretary',
  'sports secretary': 'gameSecretary',
  'joint game secretary': 'gameSecretary',
  member: 'member',
